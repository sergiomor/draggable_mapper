...
class DraggableMapperUnitTest extends UnitTestCase {
  ...
  public function testCoordinateDecimalToPercentage() {
    // Test converting decimal coordinates (0-1 range) to percentage values (0-100)
    $decimal_x = 0.25;
    $decimal_y = 0.75;
  ...
  public function testMarkerSizeCalculation() {
    ...
    $marker_width_px = 160; // 20% of container width
    $marker_height_px = 120; // 20% of container height
  ...
  public function testFontSizeCalculation() {
    ...
    $test_cases = [
      ...
      [
        'width' => 300,
        'height' => 50,
        'expected_font_size' => 12.5, // 25% of smallest dimension
      ],
      // Square marker (aspect ratio = 1)
      [
        'width' => 100,
        'height' => 100,
        'expected_font_size' => 10, // 10% of width
      ],
      // Tall marker (height > width, aspect ratio < 1)
      [
        'width' => 50,
        'height' => 150,
        'expected_font_size' => 5, // 10% of width
      ],
    ];
  ...
  public function testMarkerValidation() {
    ...
    $invalid_marker_out_of_range = $this->getMockParagraph([
      'field_dme_marker_x' => 1.5, // > 1.0 is out of range
      'field_dme_marker_y' => 0.5,
      'field_dme_marker_title' => 'Invalid Marker',
    ]);
  ...
  private function extractMarkerData($paragraph, $index) {
    ...
    $marker = [
      ...
      'title' => $paragraph->get('field_dme_marker_title')->getValue()[0]['value'] ?? '', // Fixed title access
    ];
