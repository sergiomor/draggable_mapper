...
abstract class DraggableMapperJsTestBase extends WebDriverTestBase {
   ...
   */
     ...
     * 
     * Scans the form for marker title fields and counts those with non-empty values.
     ...
     */
       ...
       * 
       * Use this when testing JavaScript interactions that depend on Drupal.behaviors
      ...
      protected function getRelativeMarkerCoordinates(int $markerIndex, int $precision = 4): array {
        ...
        list($width, $height, $x, $y) = $this->getSession()->evaluateScript($script);
